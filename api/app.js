...
var DB_URL = process.env.DB_URL || 'mongodb://140.119.19.90:27017/appbeach';
...
mongoose.connection.on('disconnected', function () {
  ...
  mongoose.connect(process.env.DB_URL || 'mongodb://140.119.19.90:27017/appbeach', {
    server: {
      auto_reconnect: true
    }
  });
...
//save app stat
app.use('/appStat', require('./routes/appStat'));
//save app comment
app.use('/appComment', require('./routes/appComment'));
//save app class
app.use('/appClassList', require('./routes/appClassList'));
// //save app behavior
